...
(define-key *top-map* (kbd "M-s-g" ) "grouplist")
...
(define-key *top-map* (kbd "s-7"               ) "layout-set 0 s-7")
(define-key *top-map* (kbd "s-8"               ) "layout-set 1 s-8")
(define-key *top-map* (kbd "s-9"               ) "layout-set 2 s-9")
...
(define-key *utl-exec-map* (kbd "g"  ) "utl-gcolor2")
